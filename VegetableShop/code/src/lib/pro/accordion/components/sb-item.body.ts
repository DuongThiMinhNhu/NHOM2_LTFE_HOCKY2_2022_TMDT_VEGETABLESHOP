...
export class SBItemBodyComponent implements AfterContentInit, OnDestroy {
    ...
    @Output() animationStateChange: EventEmitter<IAccordionAnimationState> = new EventEmitter<IAccordionAnimationState>();
    @ContentChildren(RouterLinkWithHref, {descendants: true}) routerLinks: QueryList<RouterLinkWithHref>;
