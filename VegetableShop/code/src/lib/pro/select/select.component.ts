...
export class MdbSelectComponent
    ...
    private _clearButtonTabindex = 0;
    ...
    @Output() deselected: EventEmitter<OptionComponent | OptionComponent[]> = new EventEmitter<OptionComponent | OptionComponent[]>();
